  ...
  return (
    <div className="w-[22.5rem] h-96 rounded-3xl overflow-hidden relative ">
      ...
      <div className="absolute bottom-5 left-5 right-5 bg-white px-4 py-1 h-24 rounded-2xl">
        <p className="font-montserratreg text-[0.8rem] text-secondary truncate">{locate || 'Dilem'}</p>
        <h3 className="font-montserratreg font-bold text-[1rem] text-gray-800 truncate">{title || 'Testing'}</h3>
